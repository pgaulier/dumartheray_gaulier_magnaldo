...
delete from TAG;
delete from DESCRIPTION_STAGIAIRE ;
...
insert into ENTREPRISE values(4, 'BERNARD AND CO', 'BOULEVARD DU TRAVAIL INTENSE', 42421, 'PAS A BORDEAUX', '3333333', 'www.randonnee.com', 11);
...
insert into EVENEMENT values(1, 'RACLETTE CHEZ JB', '02-DEC-16');

-- PERSONNE

insert into PERSONNE values (1, 'MOULE', 'A GAUFFRE', null, null, null);
insert into PERSONNE values (2, 'BACHI', 'BOUZOUK', null, null, null);
insert into PERSONNE values (3, 'ZOUAVE', 'INTERPLANETAIRE', null, null, null);
insert into PERSONNE values (4, 'ECTOPLASME', 'A ROULETTE', null, null, null);
insert into PERSONNE values (5, 'BULLDOZER', 'A REACTION', null, null, null);
insert into PERSONNE values (6, 'TCHOUK', 'TCHOUK-NOUGAT', null, null, null);
insert into PERSONNE values (7, 'TURFU', 'JEAN', null, null, null);

commit ;

-- CONTACT

insert into CONTACT values(4, 1, null);
insert into CONTACT values(5, 1, null);
...
insert into STAGE values(1, 1, 7, 'CREATION SONORE', '01-JAN-23', '01-JAN-24');
insert into STAGE values(2, 1, 7, 'ARCHITECTE RESEAUX', '01-JAN-23', '01-JAN-24');
insert into STAGE values(3, 1, 7, 'VIRTUALISTATION', '01-JAN-23', '01-JAN-24');
insert into STAGE values(4, 1, 6, 'ANALYSE AUTOMATIQUE', '01-JAN-23', '01-JAN-24');
insert into STAGE values(5, 2, 5, 'DETECTEUR DE SPAM', '01-JAN-23', '01-JAN-24');
insert into STAGE values(6, 3, 4, 'FUNAMISATOR', '01-JAN-23', '01-JAN-24');
...
insert into ELEVE values(7, 1, 'INFO', null, null);

commit ;

-- DESCRITPTION_STAGIAIRE

insert into DESCRIPTION_STAGIAIRE values(1, 1);
insert into DESCRIPTION_STAGIAIRE values(2, 2);
insert into DESCRIPTION_STAGIAIRE values(3, 2);
insert into DESCRIPTION_STAGIAIRE values(4, 3);
insert into DESCRIPTION_STAGIAIRE values(5, 3);
insert into DESCRIPTION_STAGIAIRE values(6, 3);
insert into DESCRIPTION_STAGIAIRE values(7, 3);
insert into DESCRIPTION_STAGIAIRE values(8, 3);
insert into DESCRIPTION_STAGIAIRE values(9, 7);
insert into DESCRIPTION_STAGIAIRE values(10, 7);
...
select count(*),'= 5 ?','ENTREPRISE' from ENTREPRISE
union
select count(*),'= 10 ?','STAGE' from STAGE
union
select count(*),'= 7 ?','PERSONNE' from PERSONNE
union
select count(*),'= 1 ?','ECOLE' from ECOLE ;
